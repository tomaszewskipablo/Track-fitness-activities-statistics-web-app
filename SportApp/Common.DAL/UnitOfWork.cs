...
namespace Common.DAL
{
    public class UnitOfWork : IDisposable
    {
        ...
        private GenericRepository<TrainingData> _trenningDataRepository;
        ...
        public GenericRepository<TrainingData> TrenningDataRepository => _trenningDataRepository ?? (_trenningDataRepository = new GenericRepository<TrainingData>(_context));
